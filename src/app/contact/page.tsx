...
interface ContactFormData {
  ...
  subject: string;
  message: string;
  contactType: 'general' | 'adoption' | 'volunteer' | 'donation';
}
    ...
    <div className="bg-secondary">
      ...
      <section className="bg-primary text-secondary py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto">
            ¿Tienes preguntas sobre nuestro proceso de adopción responsable? ¿Quieres ser voluntario 
            o hacer una donación? Estamos aquí para ayudarte. Contáctanos y te responderemos lo antes posible.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-secondary">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-accent-blue p-8 rounded-lg shadow-md">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="text-center">
                <button 
                  ...
                  className="bg-accent-orange text-primary px-8 py-3 rounded-lg font-semibold hover:bg-primary hover:text-secondary transition-colors duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-accent-orange p-6 rounded-lg">
              ...
              <p className="text-primary">
                ...
                a voluntarios@fundacionpapperros.org. Trabajamos con albergues aliados y rescatistas.
              </p>
            </div>
